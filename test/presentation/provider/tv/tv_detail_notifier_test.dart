...
void main() {
  ...
  late MockGetTvDetail mockGetDetail;
  late MockGetRecommendationsTv mockGetRecommendations;
  ...
  setUp(() {
    listenerCallCount = 0;
    mockGetDetail = MockGetTvDetail();
    mockGetRecommendations = MockGetRecommendationsTv();
    ...
    provider = TvDetailNotifier(
      getTvDetail: mockGetDetail,
      getRecommendationsTv: mockGetRecommendations,
  ...
  group('Get Movie Detail', () {
    test('should get data from the usecase', () async {
      ...
      // assert
      verify(mockGetDetail.execute(tId));
      verify(mockGetRecommendations.execute(tId));
    });
    ...
    test('should change state to Loading when usecase is called', () {
      ...
      // assert
      expect(provider.tv, RequestState.Loading);
    ...
    test('should change movie when data is gotten successfully', () async {
      ...
      expect(provider.tv, testMovieDetail);
